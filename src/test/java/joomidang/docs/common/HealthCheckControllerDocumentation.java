...
/**
 * HealthCheckController API 문서화 테스트 클래스
 * RestDocsSupport를 상속받아 구현하여 헬스 체크 API 문서화를 수행합니다.
 */
public class HealthCheckControllerDocumentation extends RestDocsSupport {
